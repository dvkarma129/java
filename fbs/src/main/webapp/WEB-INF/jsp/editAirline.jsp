...
<body>
	<div id=container>
		<div id="add-form">
			<form method="post" action="/Admin/editAirline" id="form">
				<h1>Update Airline</h1>
				<input type="text" name="airlineId" value="${a.getAirlineId()}" readonly /><br />
				<input type="text" name="airlineName" value="${a.getAirlineName()}" required /><br /> 
